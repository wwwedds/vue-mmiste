  ...
  <nav class="msite_nav">
    <div class="swiper-container">
      <div class="swiper-wrapper">
        <div class="swiper-slide" v-for="(categoryPage,index) in categorysA" :key="index"> 
        
          <div class="link_to_food" v-for="(category) in categoryPage" :key='category.id'>
            ...
            <div class="shop_right">
              <section class="shop_detail_header">
                ...
                <ul class="shop_detail_ul">
                  <li class="supports" v-for="(item) in shops.supports" :key='item.id'>保</li>
