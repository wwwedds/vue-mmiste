  ...
  <div class="shop-header" v-if="info.supports">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        ...
        <p class="shop-notice ellipsis" >{{info.bulletin}}</p>
      </div>
    </div>
    <div class="shop-header-discounts">
      <div class="discounts-left"  @click="isShowmodal=true">
        <div class="activity " :class="classType[info.supports[0].type]">
          <span class="content-tag">
      ...
      <div class="discounts-right" @click="isShowsheet=true">
        {{info.supports.length}}个优惠
      </div>
    </div>
    <div class="shop-brief-modal" v-show="isShowmodal" >
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-close" @click="isShowmodal=false"></span>
        </div>
      </div>
      <div class="brief-modal-cover" ></div>
    </div>
    <div class="activity-sheet" v-show="isShowsheet">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
        优惠活动</h2>
        <ul class="list">
          <li class="activity-item " :class="classType[support.type]"
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close" @click="isShowsheet=false"></span>
        </div>
      </div>
...
import {mapState} from 'vuex'
  ...
  export default {
    data() {
      return {
        classType:['activity-green','activity-red','activity-orange'],
        isShowmodal:false,
        isShowsheet:false
